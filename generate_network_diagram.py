#!/usr/bin/env python3
"""
Script to generate network diagrams from extracted network configuration.
"""
...
def main():
    ...
    config_file = os.path.join(script_dir, "network_config.json")
    
    if not os.path.exists(config_file):
        print(f"Error: Configuration file '{config_file}' not found.")
        print("Please run extract_network_config.py first.")
        return
